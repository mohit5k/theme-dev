<?php $woof_options = get_option('woof'); ?> <!-- Tag Page -->    
...
<?php } else { ?> 	
    ...
    <div class="jumbotron jumbotron-fluid overlay">
        <div class="jumbo-heading">
			...
			<?php if(!empty($woof_options['tag-page-title'])): ?>
			<h1><?php echo esc_attr(($woof_options['tag-page-title']));?> <em><?php single_tag_title(); ?></em></h1>
			<?php else:?>
			<h1><?php esc_attr_e('Tag : ','woof');?> <em><?php single_tag_title(); ?></em></h1>
			<?php endif;?>
            </div>
			<!-- /section-heading -->
